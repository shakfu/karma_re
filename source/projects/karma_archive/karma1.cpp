...
static double karma_perform_interpolation(t_karma *x, double accuratehead, char direction, char directionorig, 
                                         long maxloop, long frames, float *b, long pchans, long interp, 
...
static void karma_perform_playback_processing(t_karma *x, double osamp1, double globalramp, double snrramp, 
                                             long snrtype, double *snrfade, long *playfade, 
...
static void karma_perform_cleanup(t_karma *x, t_buffer_obj *buf, t_bool dirt, t_bool go, 
...
static void karma_perform_init_state(t_karma *x, t_buffer_obj *buf, float **b_ptr, 
                                   ...
                                   double *globalramp, double *snrramp, long *snrtype,
                                   long *interp, double *speedfloat)
{
    *record = x->record;
...
static void karma_perform_loop_playback(t_karma *x, t_bool go, t_bool loopdetermine,
...
static void karma_perform_state_update(t_karma *x, t_buffer_obj *buf, t_bool dirt,
                                     double o1prev, double o1dif, double writeval1,
